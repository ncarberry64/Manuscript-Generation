...
## D1 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â S3 spectrum
Input:
...
## D2 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â n=1 scalar observer-sky projection
Using the R4 embedding of S3:
`T_1=A[u_4 cos psi + u_vecÃƒâ€šÃ‚Â·n_hat sin psi]`.

Result: a fixed-radius shell of the scalar function contains sky monopole + dipole only.

Status: exact scalar geometry.

## D2G ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â exceptional closed-FLRW metric sector
...
## D3 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Schur-generated higher-spatial stiffness
...
## D4 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â harmonic filter
Set `L_c=a R_H ell`.
...
## D5 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â cubic-Galileon kinetic diagnostic
...
## D6 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â R1 background
Numerical branch:
...
## D8 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â carried-forward observational calibration
...
## D9 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â frozen curvature target
`Omega_k=-0.018 Ãƒâ€šÃ‚Â± 0.004`.
...
## D10 Ã¢â‚¬â€ exceptional n=1 no-go in regular one-field closed FLRW
...
## D11 Ã¢â‚¬â€ first physical n=2 pure-dipole subspace
...
transfer matrix.
## D14 â€” matter-sourced n=2 constraint transfer
