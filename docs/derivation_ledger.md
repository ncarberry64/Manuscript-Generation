...
## D1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â S3 spectrum
Input:
...
## D2 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â n=1 scalar observer-sky projection
Using the R4 embedding of S3:
`T_1=A[u_4 cos psi + u_vecÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â·n_hat sin psi]`.

Result: a fixed-radius shell of the scalar function contains sky monopole + dipole only.

Status: exact scalar geometry.

## D2G ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â exceptional closed-FLRW metric sector
...
## D3 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Schur-generated higher-spatial stiffness
...
## D4 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â harmonic filter
Set `L_c=a R_H ell`.
...
## D5 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â cubic-Galileon kinetic diagnostic
...
## D6 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â R1 background
Numerical branch:
...
## D7 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â R1 growth
...
## D8 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â carried-forward observational calibration
...
## D9 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â frozen curvature target
`Omega_k=-0.018 ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â± 0.004`.
...
## D10 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â exceptional n=1 no-go in regular one-field closed FLRW
...
## D11 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â first physical n=2 pure-dipole subspace
...
## D12 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â corrected physical harmonic filter
`n=2` softened and `n>=3` stiffened gives `1/15 < ell^2 < 1/8`, with next physical response `|(T3/S3)/(T2/S2)|=8 C2/(15 C3)`.
## D13 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â exact closed-Horndeski n=2 constraint kernel
...
transfer matrix.
## D14 Ã¢â‚¬â€ matter-sourced n=2 constraint transfer

Curvature-aware EFT source equations are specialized to:
`alpha_M=alpha_T=alpha_H=0`,
`M^2=M_Pl^2`,
ideal dust+radiation,
manuscript n=2.
...
The 00 and 0i equations form a 2x2 system for
`(Phi_dot, pi_dot)`.

Exact determinant:
`det C = -2 H^2 (alpha_K + 6 alpha_B^2)`
`      = -2 H^2 (D_kin + 9 alpha_B^2/2)`.

Status:
exact local sourced-constraint result in the curvature-aware EFT convention.
Global evolution remains gated on an analytic convention match plus
Bianchi/constraint-preservation test.
## D15 â€” ADM/EFT gauge dictionary and redundant-equation audit

Linear time shift from unitary ADM gauge to Newtonian gauge:
...
The sourced 00/0i+fluid system defines the local flow. The unused ij-trace
and scalar-pi equations are evaluated as Bianchi/redundancy residuals using
`x_ddot = H T_N x + T^2 x`.

Status:
exact kinematic dictionary plus numerical consistency audit. Topographic
response remains off.
