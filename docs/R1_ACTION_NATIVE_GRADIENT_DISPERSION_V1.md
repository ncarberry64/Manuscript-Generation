...
- High-n sequence: `[40, 80, 160, 320]`
- Maximum extrapolated Re(s)/sqrt(k^2) intercept: `0.0037985866607190746`
- Minimum extrapolated non-radiation propagating c^2: `0.9441510023494406`
- Maximum radiation-branch |c^2-1/3|: `0.0018271834729365888`
