...
\begin{align}
\mathcal F^{\rm state}_{f\sigma_8}(0)&=(2.172303247e+00,\,3.071170118e-02),\\
\mathcal F^{\rm state}_{\rm Weyl}(0)&=(6.167895805e-02,\,-2.498933170e-02).
\end{align}

These are not two new amplitudes.  They are the two components of linear functionals acting on the same initial $n=2$ state.  The single-calibration theorem collapses them to one observable prediction once the luminosity-distance light-cone functional fixes that state.
