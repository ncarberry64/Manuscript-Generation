...
Rounds 3 and 4 use complementary perturbation languages. Akama and Kobayashi formulate the non-flat Horndeski action in unitary ADM gauge,
\[
N=1+\delta n,\qquad
N_i=D_i\chi,\qquad
...
The repository now integrates the trace/scalar equations together with ideal dust and radiation conservation, starting from data that satisfy the sourced \(00\) and \(0i\) constraints. The Bianchi audit is then the preservation of those two constraints over the interval
\[
2.1\ge z\ge0.
\]
Both raw and term-normalized constraint residuals are evaluated. The topographic reduced-response operator remains switched off throughout this certification.
